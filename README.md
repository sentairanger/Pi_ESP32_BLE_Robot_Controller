...
## Controlling Robot with ESP32 Controller PCB

This [Repository](https://github.com/sentairanger/Pi_ESP32_BLE_Robot_Controller) now hosts the relevant files to manufacture and test the ESP32 Controller to control a Raspberry Pi Robot. 
